 ...
 */
class User extends \CalendarBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'CalendarBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'CalendarBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'CalendarBundle\\Entity\\User' . "\0" . 'phonenumber', '' . "\0" . 'CalendarBundle\\Entity\\User' . "\0" . 'calendar', '' . "\0" . 'CalendarBundle\\Entity\\User' . "\0" . 'calendars', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
