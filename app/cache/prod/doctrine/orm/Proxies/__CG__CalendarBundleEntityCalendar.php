 ...
 */
class Calendar extends \CalendarBundle\Entity\Calendar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CalendarBundle\\Entity\\Calendar' . "\0" . 'id', '' . "\0" . 'CalendarBundle\\Entity\\Calendar' . "\0" . 'nom', '' . "\0" . 'CalendarBundle\\Entity\\Calendar' . "\0" . 'dateCreation', '' . "\0" . 'CalendarBundle\\Entity\\Calendar' . "\0" . 'events');
        }
