 ...
 */
class Event extends \CalendarBundle\Entity\Event implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CalendarBundle\\Entity\\Event' . "\0" . 'id', '' . "\0" . 'CalendarBundle\\Entity\\Event' . "\0" . 'titre', '' . "\0" . 'CalendarBundle\\Entity\\Event' . "\0" . 'description', '' . "\0" . 'CalendarBundle\\Entity\\Event' . "\0" . 'lieu', '' . "\0" . 'CalendarBundle\\Entity\\Event' . "\0" . 'dateDebut', '' . "\0" . 'CalendarBundle\\Entity\\Event' . "\0" . 'dateFin', '' . "\0" . 'CalendarBundle\\Entity\\Event' . "\0" . 'heureDebut', '' . "\0" . 'CalendarBundle\\Entity\\Event' . "\0" . 'heureFin', '' . "\0" . 'CalendarBundle\\Entity\\Event' . "\0" . 'calendar');
        }
